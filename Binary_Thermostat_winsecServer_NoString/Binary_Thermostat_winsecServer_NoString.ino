...
void loop() {
  if (now() > tempCheck) {
    ...
    while (!(piServer1.connected())) {
      if (piServer1.connect(IP2, PORT2) != 1) {
        break;
      }
